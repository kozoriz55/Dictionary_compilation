...
with open("C:\\Users\\davin\\Desktop\\zh_orpho.txt", 'r', encoding='utf-8') as f:
	chinese_dictionary = {word.split('+')[0] for word in f.readlines()}
chinese_words = split_chinese_text(chinese_text, chinese_dictionary)
with open("C:\\Users\\davin\\Desktop\\mil_corpus_s_.txt", 'wt', encoding='utf-8') as f2:
...
with open("C:\\Users\\davin\\Desktop\\mil_corpus_dict.txt", 'w', encoding='utf-8') as json_file:
